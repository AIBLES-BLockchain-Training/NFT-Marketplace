      ...
      <div className="w-full px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              Decentralized NFT Marketplace built on Ethereum. Buy, sell, and discover unique digital assets.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/explore" className="text-gray-400 hover:text-primary-400 text-sm transition-colors">
                  Explore
                </Link>
              </li>
              <li>
                <Link href="/collections" className="text-gray-400 hover:text-primary-400 text-sm transition-colors">
                  Collections
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-dark-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm">
            {currentYear} AIBLES NFT Marketplace. All rights reserved.
          </p>
